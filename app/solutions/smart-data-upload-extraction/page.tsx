...
import { ArrowUpRight, Check, Mail, Plus, ChevronRight, Upload, Database } from "lucide-react"

export default function SmartDataUpload() {
  return (
      ...
      <main className="w-full max-w-6xl mx-auto grid gap-12 py-12">
        ...
        <section className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-headline font-semibold leading-tight">
              Smart Data Upload and Extraction for Recruiters
            </h1>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-headline font-regular text-[#0075DE] leading-tight">
              Transform raw spreadsheets into ready-to-use client profiles
            </h2>
            <p className="text-lg text-gray-700 max-w-md">
              Upload Excel or CSV files and let JOTIQ extract and organize all key contact data. Perfect for recruiters managing large lead lists or legacy databases.
            </p>
          </div>
        ...
        <section className="grid md:grid-cols-2 gap-12 mt-12">
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6">
              Manual data entry slows you down and creates errors. JOTIQ processes your uploads instantly and creates structured profiles ready for outreach.
            </p>
          </div>
        </section>
        ...
        <section className="mt-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <h4 className="text-xl font-semibold">Upload a CSV or Excel file</h4>
            </div>
            <div className="text-center space-y-4">
              <div className="w-16 h-16 flex items-center justify-center bg-[#0075DE] text-white rounded-full text-2xl font-bold mx-auto">
                2
              </div>
              <h4 className="text-xl font-semibold">JOTIQ extracts key contact details</h4>
            </div>
            <div className="text-center space-y-4">
              <div className="w-16 h-16 flex items-center justify-center bg-[#0075DE] text-white rounded-full text-2xl font-bold mx-auto">
                3
              </div>
              <h4 className="text-xl font-semibold">Profiles are created for outreach</h4>
            </div>
          </div>
        </section>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <p className="text-lg text-gray-700">Speed up data onboarding</p>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-[#0075DE] shrink-0 mt-1" />
                <p className="text-lg text-gray-700">Improve data accuracy and structure</p>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-[#0075DE] shrink-0 mt-1" />
                <p className="text-lg text-gray-700">Build client lists ready for outreach campaigns</p>
              </li>
            </ul>
          </div>
          <div className="flex items-center justify-center">
            <p className="text-2xl font-semibold italic text-gray-800 text-center">
              &quot;Get started with smart data import&quot;
            </p>
          </div>
        </section>
        ...
        <section className="flex flex-col items-center justify-center mt-12 space-y-6">
          ...
          <p className="text-md text-gray-600 text-center max-w-lg">
            For seamless follow-up, explore {' '}
            <a 
