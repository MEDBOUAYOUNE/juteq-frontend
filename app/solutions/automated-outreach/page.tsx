      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center relative z-10">
          ...
          <p className="text-lg text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto">
            Save hours on client outreach by streamlining your emails,
    ...
    <div className="space-y-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-6">
        <div>
          ...
          <p className="text-base text-gray-600 mb-6 leading-relaxed">
            JOTIQ helps recruiters and agencies simplify their client outreach. With smart automation, you
            can schedule follow-ups, generate personalized outreach emails more efficiently and keep
            communication consistent without starting from scratch each time.
          </p>
        </div>
        <div className="relative flex justify-center items-center">
          <Image
            src="/placeholder.svg?height=400&width=600"
            alt="AI-Powered Outreach Engine Illustration"
            width={300}
            height={200}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-6">
        <div>
          ...
          <p className="text-base text-gray-600 mb-6 leading-relaxed">
            JOTIQ reduces the manual steps in your outreach process. It assists with drafting personalized
            messages, sends automated follow-ups based on timing rules and helps you schedule meetings
            with prospects. Everything works together to keep your workflow smooth and scalable.
          </p>
        </div>
        <div className="relative flex justify-center items-center">
          <Image
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-6">
        <div>
          ...
          <p className="text-base text-gray-600 mb-6 leading-relaxed">
            By streamlining repetitive tasks, JOTIQ frees up time for real conversations. The platform helps
            maintain a steady outreach rhythm, increases engagement and ensures your follow-ups happen
            at the right moment.
          </p>
        </div>
        <div className="relative flex justify-center items-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-red-50 rounded-2xl p-8 border border-red-100 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Recruiters often lose valuable time manually writing emails, tracking follow-ups and scheduling meetings.
            ...
            <div className="bg-green-50 rounded-2xl p-8 border border-green-100 hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="space-y-3">
                {[
                  "Save up to 10 hours per week by automating client outreach tasks",
                  "Improve consistency and follow-up timing",
...
>>>>>>> c4c30333526234a38495438508d9322776d1612c
