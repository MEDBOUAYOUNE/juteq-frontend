    ...
    <section className="py-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
          <div>
            <h3 className="text-2xl font-bold font-headline text-black mb-6">Smarter Email Outreach, More Replies.</h3>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
          ...
          <div className="md:order-2">
            <h3 className="text-2xl font-bold text-black mb-6">AI-Powered Calls, More Conversations.</h3>
            <p className="text-lg text-gray-700 leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
          <div>
            <h3 className="text-2xl font-bold font-headline text-black mb-6">Real-Time Job Leads, More Opportunities.</h3>
            <p className="text-lg text-gray-700 leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="md:order-2">
            <h3 className="text-2xl font-bold font-headline text-black mb-6">Actionable Analytics, Better Results.</h3>
            <p className="text-lg text-gray-700 leading-relaxed">
